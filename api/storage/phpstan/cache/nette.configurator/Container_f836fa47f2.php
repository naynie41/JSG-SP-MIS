...
class Container_f836fa47f2 extends _PHPStan_48ec32058\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_f836fa47f2 $container)
			{
	...
	public function createServiceContainer(): Container_f836fa47f2
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'CACHE_STORE' => 'redis',
				'CHROME_CRASHPAD_PIPE_NAME' => '\\\.\pipe\crashpad_1476_YQEGBZMCGMJMOBSM',
				'CLAUDECODE' => '1',
