...
class Container_0bc63c5dcd extends _PHPStan_48ec32058\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_0bc63c5dcd $container)
			{
	...
	public function createServiceContainer(): Container_0bc63c5dcd
	{
		return $this;
	}
