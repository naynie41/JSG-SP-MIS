...
class Container_199cc2b405 extends _PHPStan_48ec32058\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_199cc2b405 $container)
			{
	...
	public function createServiceContainer(): Container_199cc2b405
	{
		return $this;
	}
