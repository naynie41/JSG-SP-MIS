...
class Container_8d796a46d9 extends _PHPStan_48ec32058\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_8d796a46d9 $container)
			{
	...
	public function createServiceContainer(): Container_8d796a46d9
	{
		return $this;
	}
