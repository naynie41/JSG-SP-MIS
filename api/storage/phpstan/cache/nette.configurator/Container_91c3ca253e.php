...
class Container_91c3ca253e extends _PHPStan_48ec32058\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_91c3ca253e $container)
			{
	...
	public function createServiceContainer(): Container_91c3ca253e
	{
		return $this;
	}
