...
class Container_e8624cea74 extends _PHPStan_48ec32058\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_e8624cea74 $container)
			{
	...
	public function createServiceContainer(): Container_e8624cea74
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'CACHE_STORE' => 'redis',
				'CHROME_CRASHPAD_PIPE_NAME' => '\\\.\pipe\crashpad_6100_JVIDKPQSXJGDSNOX',
				'CLAUDECODE' => '1',
				...
				'CLAUDE_CODE_EXECPATH' => 'C:\Users\ACER\.vscode\extensions\anthropic.claude-code-2.1.234-win32-x64\resources\native-binary\claude.exe',
