...
class Container_5c2841248b extends _PHPStan_48ec32058\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_5c2841248b $container)
			{
	...
	public function createServiceContainer(): Container_5c2841248b
	{
		return $this;
	}
