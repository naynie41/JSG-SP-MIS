...
class Container_25fbd341f0 extends _PHPStan_48ec32058\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_25fbd341f0 $container)
			{
	...
	public function createServiceContainer(): Container_25fbd341f0
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'CHROME_CRASHPAD_PIPE_NAME' => '\\\.\pipe\crashpad_1928_QZHRXULDIXRVHDUO',
				'CLAUDECODE' => '1',
				...
				'CLAUDE_CODE_EXECPATH' => 'C:\Users\ACER\.vscode\extensions\anthropic.claude-code-2.1.220-win32-x64\resources\native-binary\claude.exe',
