...
class Container_2bfa937d1c extends _PHPStan_48ec32058\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_2bfa937d1c $container)
			{
	...
	public function createServiceContainer(): Container_2bfa937d1c
	{
		return $this;
	}
