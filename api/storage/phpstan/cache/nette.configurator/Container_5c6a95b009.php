...
class Container_5c6a95b009 extends _PHPStan_48ec32058\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_5c6a95b009 $container)
			{
	...
	public function createServiceContainer(): Container_5c6a95b009
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				'AI_AGENT' => 'claude-code_2-1-224_agent',
				'ALLUSERSPROFILE' => 'C:\ProgramData',
				'APPDATA' => 'C:\Users\ACER\AppData\Roaming',
				'CHROME_CRASHPAD_PIPE_NAME' => '\\\.\pipe\crashpad_10972_PGGDMKITSNMUALXZ',
				'CLAUDECODE' => '1',
				'CLAUDE_AGENT_SDK_VERSION' => '0.3.224',
				'CLAUDE_CODE_CHILD_SESSION' => '1',
				'CLAUDE_CODE_ENABLE_SDK_FILE_CHECKPOINTING' => 'true',
				'CLAUDE_CODE_ENABLE_TASKS' => '0',
				'CLAUDE_CODE_ENTRYPOINT' => 'claude-vscode',
				'CLAUDE_CODE_EXECPATH' => 'C:\Users\ACER\.vscode\extensions\anthropic.claude-code-2.1.224-win32-x64\resources\native-binary\claude.exe',
