...
const MdaServiceDeliveryPage = lazy(() => import('@/features/mda/mdaScaffolds').then((m) => ({ default: m.MdaServiceDeliveryPage })))
const MdaDuplicateResolutionPage = lazy(() => import('@/features/mda/mdaScaffolds').then((m) => ({ default: m.MdaDuplicateResolutionPage })))
const MdaReportsPage = lazy(() => import('@/features/mda/mdaScaffolds').then((m) => ({ default: m.MdaReportsPage })))
const MdaSettingsPage = lazy(() => import('@/features/mda/mdaScaffolds').then((m) => ({ default: m.MdaSettingsPage })))
