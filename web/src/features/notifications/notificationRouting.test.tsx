 ...
 *
 * MDA Officers and Admins work in the six-module MDA workspace and no longer have the
...
describe('notification deep-linking', () => {
  ...
  it('sends a referral to its detail page for both consoles', () => {
    ...
    expect(linkFor(n, 'mda_officer')).toBe('/referrals/r1')
  ...
  it('sends a request-to-serve into the MDA’s Service Delivery module', () => {
    ...
    expect(linkFor(n, 'mda_officer')).toBe('/mda/service-delivery?tab=service-requests')
  ...
  it('sends a duplicate alert to Duplicate Resolution, not the import screen', () => {
    ...
    expect(linkFor(n, 'mda_officer')).toBe('/mda/duplicate-resolution')
  ...
  it('sends an import result to that batch', () => {
    ...
    expect(linkFor(n, 'mda_officer')).toBe('/imports/ib7')
  ...
  it('distinguishes a duplicate alert from an import result on the same batch', () => {
    ...
    expect(linkFor(notification('import.duplicates_surfaced', batch), 'mda_officer'))
      .not.toBe(linkFor(notification('import.completed', batch), 'mda_officer'))
  })
  ...
  it('leaves a system announcement in the panel', () => {
    ...
    expect(linkFor(notification('system.announcement'), 'mda_officer')).toBeNull()
  ...
  it('routes a ready report to the reader’s own reports module', () => {
    ...
    expect(linkFor(n, 'mda_officer')).toBe('/mda/reports')
